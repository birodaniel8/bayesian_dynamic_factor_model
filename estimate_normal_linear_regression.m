function [sampled_beta, sampled_sigma_squared] = estimate_normal_linear_regression(y,x,priors,ndraw,burnin,constant,display)
% ESTIMATE_NORMAL_LINEAR_REGRESSION
